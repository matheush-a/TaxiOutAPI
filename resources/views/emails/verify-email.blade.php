...
@section('content')
    ...
    <section style="width:100%; display:flex; justify-content:center; flex-wrap:wrap; margin-top:10px;">
        <a href="{{$link}}" style="background-color:#f37350; border-radius:6px; color:#fff; display:block; font-weight:700; padding:15px 60px; text-decoration:none; width:30%; text-align:center;">
            Validar meu e-mail
        </a>
    </section>
    </p>
